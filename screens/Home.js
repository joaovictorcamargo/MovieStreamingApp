...
import {COLORS, dummyData, SIZES, FONTS, image, icons} from './constants';
import {Profile,ProgressBar} from '../components';
...
const Home = ({ navigation }) => {
    ...
    function renderNewSeasonSections() {
        return(
            <Animated.FlatList
            horizontal
            paddingEnabled
                        ...
                        return (
                            ...
                            >
                                ...
                                style={{
                                    ...
                                    marginRight: index == dummyData.continueWatching.length - 1 ? SIZES.padding :
                                    0
                                }}
                                >
